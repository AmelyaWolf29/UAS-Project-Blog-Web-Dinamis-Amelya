...
<head>
    ...
    <meta name="description" content="@yield('meta_description', 'Website Blog Artikel Terlengkap tentang Restaurant dan Teknologi')">
    <meta name="keywords" content="@yield('meta_keywords', 'blog, article, technology, food')">
